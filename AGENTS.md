...
- TODO: evaluate whether the default Hermes `SOUL.md` feels too technical for Israeli WhatsApp users. Do not customize `SOUL.md` until this is tested.
...
- Docker cleanup may prune unused images/build cache only. Never automate `docker volume prune`; tenant state lives in volumes.
