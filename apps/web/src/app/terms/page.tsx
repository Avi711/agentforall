  ...
  return (
    <LegalPage title="תנאי שימוש" updated="אפריל 2026">
      ...
      <section>
        ...
        <p>
          המנוי החודשי מתחיל מ-99 ש״ח לחודש (כולל מע״מ). המחיר הסופי תלוי בהיקף השימוש ובמשאבים הנצרכים. ניתן לבטל את המנוי בכל עת דרך האזור האישי; הביטול ייכנס לתוקף בסוף החודש הנוכחי, ללא החזר על חלק החודש שחלף.
        </p>
        <p className="mt-3">
