  ...
  return (
    <LegalPage title="מדיניות החזרים" updated="ספטמבר 2026">
      ...
      <section>
        ...
        <p>
          שדרוג נכנס לתוקף מיד: מחייבים את הכרטיס השמור על יתרת התקופה הנוכחית, והקרדיטים המתאימים נוספים ברגע שהחיוב עובר. הסכום
          המדויק מוצג לפני האישור. מעבר לתוכנית זולה יותר נכנס לתוקף בחידוש הבא, בלי חיוב ובלי החזר: התוכנית הנוכחית והקרדיטים שלה
          נשארים עד אז, ואפשר לבטל את המעבר עד שעה לפני החידוש. מעבר מתוכנית חודשית לשנתית מחויב מיד ומתחיל שנה חדשה, ותוכנית שנתית
          משנים דרכנו.
        </p>
      </section>
