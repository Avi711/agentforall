...
- Current orchestrator image: `europe-west4-docker.pkg.dev/agent-for-all/agent-forall/orchestrator@sha256:42dd2664f6bf674b2c08ffd44c49a1b0d92e09fb97c5ca5c4d7f890aea23ed4e` (deployed 2026-08-21: WhatsApp owner claim/access, per-channel disconnect, per-peer sessions, `budgetResetAt` from LiteLLM `budget_reset_at`; previous `f947560e…` added `recreate`).
